...
void testInsert(){
    ...
    ofstream myfile;
    myfile.open (R"(C:\Users\lojaz\CLionProjects\Hillbert\insertTest.csv)");
    auto tree = new RTree();
    for(int j = 0; j < 100; ++j)
    {
        tree = new RTree();
...
void testSearch(){
    ...
    using high_resolution_clock = std::chrono::steady_clock;
    ofstream myfile;
    myfile.open (R"(C:\Users\lojaz\CLionProjects\Hillbert\searchTest.csv)");
...
void testRemove(){
    ...
    using high_resolution_clock = std::chrono::steady_clock;
    ofstream myfile;
    myfile.open (R"(C:\Users\lojaz\CLionProjects\Hillbert\removeTest.csv)");
...
void knn1Search(){
    ...
    using high_resolution_clock = std::chrono::steady_clock;
    ofstream myfile;
    myfile.open (R"(C:\Users\lojaz\CLionProjects\Hillbert\knn1.csv)");
...
void knn2Search(){
    ...
    using high_resolution_clock = std::chrono::steady_clock;
    ofstream myfile;
    myfile.open (R"(C:\Users\lojaz\CLionProjects\Hillbert\knn2.csv)");
...
void knn3Search(){
    ...
    using high_resolution_clock = std::chrono::steady_clock;
    ofstream myfile;
    myfile.open (R"(C:\Users\lojaz\CLionProjects\Hillbert\knn3.csv)");
    for(int j = 0; j < 100; ++j)
    {
        RTree *tree = new RTree();
        cout << "j: " << j << endl;
