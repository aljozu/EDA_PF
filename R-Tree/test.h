...
void testInsert(){
    ...
    ofstream myfile;
    myfile.open (R"(C:\Users\lojaz\CLionProjects\lines - copia\insertTest.csv)");
...
void testSearch(){
    ...
    using high_resolution_clock = std::chrono::steady_clock;
    ofstream myfile;
    myfile.open (R"(C:\Users\lojaz\CLionProjects\lines - copia\searchTest.csv)");
...
void testRemove(){
    ...
    using high_resolution_clock = std::chrono::steady_clock;
    ofstream myfile;
    myfile.open (R"(C:\Users\lojaz\CLionProjects\lines - copia\removeTest.csv)");
...
void knn1Search(){
    ...
    using high_resolution_clock = std::chrono::steady_clock;
    ofstream myfile;
    myfile.open (R"(C:\Users\lojaz\CLionProjects\lines - copia\knn1.csv)");
...
void knn2Search(){
    ...
    using high_resolution_clock = std::chrono::steady_clock;
    ofstream myfile;
    myfile.open (R"(C:\Users\lojaz\CLionProjects\lines - copia\knn2.csv)");
...
void knn3Search(){
    ...
    using high_resolution_clock = std::chrono::steady_clock;
    ofstream myfile;
    myfile.open (R"(C:\Users\lojaz\CLionProjects\lines - copia\knn3.csv)");
